"""By running this code, Figure 4b and 4d from the paper can be reproduced. """
...
num_nodes = 1784 #does nothing when dataset is BC or Flickr
dataset = "BC" #BC, Flickr, full_sim
T = int(0.05*num_nodes) #number of treated nodes, does nothing if do_full is True
do_greedy =  True 
do_GA = True
do_CELF = True

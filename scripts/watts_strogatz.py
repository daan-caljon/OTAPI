...
num_nodes = 2000 #does nothing when dataset is BC or Flickr
...
if not do_only_allocations:
    ...
    data_generator.simulate_data(dataset= dataset,w_c = w_c,w = w,w_beta_T2Y = w_beta_T2Y,betaConfounding = betaConfounding,betaNeighborConfounding = betaNeighborConfounding,
                        ...
                        betaNeighborTreatment2Outcome = betaNeighborTreatment2Outcome,betaNoise = betaNoise,beta0 = beta0,nodes = num_nodes,flipRate = flipRate,covariate_dim = covariate_dim,setting = setting,watts_strogatz=watts_strogatz)
